 ...
 *
 * FEATURES:
 * - Initialization with data loader.
 * - Navigation through items (next, previous).
 * - State management for animations and transitions.
 * - Support for both looping and non-looping carousel.
 * - Dynamic loading and ordering of carousel items.
 * - Debug mode for development and testing.
 *
 * TO DO:
 * - Implement enhanced error handling and input validation.
 * - Optimize performance for large data sets.
 * - Add support for customizable animation curves.
 * - Implement user interaction handlers (e.g., swipe gestures).
 *
 */
...
namespace SJ.ImageGallery {
    ...
    public class CarouselView : MonoBehaviour, IGalleryView {
        ...
        /// <summary>
        /// The total number of data content. This value determines the initial index and order of items. While you can set this value manually for visualization in the editor, it will be overridden by data information at runtime.
        /// </summary>
        ...
        /// <summary>
        /// Enables debug mode for displaying additional information and enabling extra functionalities during development and testing.
        /// </summary>
        public bool isDebugMode = true;

        #endregion

        #region IGalleryView Implementation
