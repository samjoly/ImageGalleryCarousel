...
namespace SJ.ImageGallery {
    /// <summary>
    /// Provides functionality to animate the opening and closing of UiGesture.
    /// </summary>
    /// <Features>
    ///     <list type="bullet">
    ///         <item>Animate UiGesture using scale transformations with customizable easing.</item>
    ...
    ///     </list>
    /// </Features>
    public class UiGestureOpener : MonoBehaviour {
        [FormerlySerializedAs("gallery")]
        ...
        private void Start() {
            uiGesture.transform.localScale = Vector3.one * closeScale;
            onCloseStart.Invoke();
        }
        ...
        private void Animate(bool opening) {
            ...
            startEvent?.Invoke();
            _tweenScale = uiGesture.transform.DOScale(targetScale, duration)
                .SetEase(ease)
                .OnComplete(() => {
